import { VictoryChart, VictoryLine, VictoryTheme, VictoryTooltip, VictoryVoronoiContainer, ScaleName } from 'victory'
...
const Chart = ({ csvData }: Props) => {
  ...
  const options = {
    ...
    scale: { x: 'time' as ScaleName, y: 'time' as ScaleName },
  }

  // 아래 animate는 Victory 최신 버전 버그 때문에 꺼둠
  // https://github.com/FormidableLabs/victory/issues/2359
